...
// FALSE не является значением типа Boolean
...
val v19: Float = 5.75f
// Кавычки не предназначены для числовых литералов
...
// Типографские кавычки “ ” вместо обычных двойных кавычек
// val v32: String = “🤯”
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// Типографские кавычки ‘ ’ вместо обычных одинарных кавычек
// val v34: Char = ‘65535’
...
// TRUE не является значением типа Boolean. true должно быть с маленькой буквы
...
//Хранить количество нажатий котом на клавиатуру ноутбука за всё время твоей работы. - Long
